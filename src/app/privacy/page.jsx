    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          At <strong>Refilly</strong>, your privacy is our top priority. This
        ...
        <p className="text-gray-600 mb-4">
          Refilly does not sell or rent your personal data to third parties. We
          only share necessary information with trusted service providers such
          as delivery partners, payment gateways, and IT support teams to
        ...
        <p className="text-gray-600 mb-4">
          ...
          information stored with us. You may also opt out of promotional emails
          at any time by clicking the “unsubscribe” link. For requests regarding
        ...
        <p className="text-gray-600 mb-4">
          Refilly does not knowingly collect personal data from children under
        ...
        <p className="text-gray-600 mb-4">
          ...
          <a
            href="mailto:privacy@refilly.com"
