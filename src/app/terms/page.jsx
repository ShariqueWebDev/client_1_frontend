    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          Welcome to <strong>Refilly</strong>. By accessing or using our
        ...
        <p className="text-gray-600 mb-4">
          These Terms & Conditions apply to all users of Refilly’s website and
        ...
        <p className="text-gray-600 mb-4">
          ...
          secure gateway partners, and Refilly is not responsible for any
        ...
        <p className="text-gray-600 mb-4">
          ...
          Refilly is not liable for delays caused by courier services or
        ...
        <p className="text-gray-600 mb-4">
          ...
          designs, is the property of Refilly. Unauthorized use, reproduction,
        ...
        <p className="text-gray-600 mb-4">
          Refilly will not be held liable for any indirect, incidental, or
